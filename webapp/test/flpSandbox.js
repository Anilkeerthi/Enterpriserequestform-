		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comenterpriseformenterpriserequestformm-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comenterpriseformenterpriserequestformm-display": {
								"semanticObject": "comenterpriseformenterpriserequestformm",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.enterpriseform.enterpriserequestformm",
									"url": sap.ui.require.toUrl("com/enterpriseform/enterpriserequestformm")
								}
							}
						}
					}
